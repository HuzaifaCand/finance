  ...
  return (
    <tbody className="bg-background">
      {rows.map((item, idx) => (
        ...
        >
          <td className="py-2 px-2 [@media(min-width:460px)]:px-3 [@media(min-width:740px)]:px-4 text-[10px] sm:text-xs text-moreWhite">
            {item.desc}
          </td>
          <td className="py-2 px-2 [@media(min-width:460px)]:px-3 [@media(min-width:740px)]:px-4 text-[10px] sm:text-xs text-moreWhite">
            {item.category}
          ...
          <td className="py-2 px-2 [@media(min-width:460px)]:px-3 [@media(min-width:740px)]:px-4">
