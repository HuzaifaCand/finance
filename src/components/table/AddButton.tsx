  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        className={`text-white p-1 rounded-full hover:bg-secondary transition ${
          open ? "bg-secondary" : ""
        }`}
      ...
      {open && (
        <div
          ref={popoverRef}
          className="absolute right-0 mt-2 w-55 bg-secondary text-white rounded-md shadow-lg z-50"
        >
          <button
            onClick={() => {
