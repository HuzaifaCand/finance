...
export default function TotalBudgetCard() {
  ...
  return (
    <div className="relative rounded-2xl bg-secondary/60 py-10 px-6 sm:h-[600px] h-[500px] flex flex-col items-center justify-center text-moreWhite">
      {/* Content (blurred when Coming Soon overlay is active) */}
      <div className="blur-sm pointer-events-none select-none">
        ...
        {/* Title */}
        <h1 className="text-lg sm:text-xl md:text-3xl font-bold text-primary text-center mb-2 sm:mb-4">
        ...
        <div className="max-w-md w-full mb-4">
          <div className="h-3 w-full bg-muted/40 rounded-full overflow-hidden">
            <div
              className="h-3 bg-teal-400 rounded-full transition-all duration-300 ease-out"
      ...
      <div className="absolute inset-0 bg-black/20 flex items-center justify-center animate-fadeIn">
        <span className="bg-tealBg/50 px-8 py-2 rounded-full text-white font-semibold text-lg sm:text-xl drop-shadow-md">
          Feature Coming Soon
        </span>
      </div>
    </div>
