          ...
          <div className="space-y-4 text-xs sm:text-sm leading-relaxed">
            ...
            <section>
              ...
              <p className="text-muted">
                ...
                can build awareness of your habits, avoid surprises at the end
                of the month, and start developing healthy financial routines
                early. Setting budgets keeps you in control. Statistics give you
                clarity on your spending. Its just an all round win.
              </p>
            </section>
          </div>
